...
struct WIFI_FUNCTION_UPLOAD_T8_HEAD :public WIFI_FUNCTION_UPLOADFILE_FILE_HEAD
{
	WIFI_FUNCTION_UPLOAD_T8_HEAD(WIFI_INFO & info) :WIFI_FUNCTION_UPLOADFILE_FILE_HEAD(info)
	{
		functionID = 0x85;
	}
	virtual const char * FUNCTION_NAME()
...
{
	return new WIFI_FUNCTION_UPLOAD_T8_HEAD(wifi);
}
