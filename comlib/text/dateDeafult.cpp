...
CFG_INFO T6[] = {
	...
	T6_Set_data(41, Sn3gain, dateType::INT32, setDefault(int, 0)),
	T6_Set_data(42, Sn3expo, dateType::INT32, setDefault(int, 0)),

	T6_Set_data(43, gain, dateType::INT32, setDefault(int, 10)),
